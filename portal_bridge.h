...
extern char* VerifyHopRouteJSON(char* cRouteJSON, char* cMethod);
extern char* IssueLeaseTokenJSON(char* cPrivateKeyHex, char* cKeyID, char* cIssuer, char* cIdentityJSON, int cTTLSeconds);
